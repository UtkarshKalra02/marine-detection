...
parser.add_argument('--initialLearningRate', type=float, default=1e-3, help="initial learning rate to train the model")
parser.add_argument('--decayLearningRate', type=float, default=0, help="learning rate decay, helps stabilizing model")
